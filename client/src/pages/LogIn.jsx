    ...
    const handleSubmit = async (e) =>{
        ...
        try {
            if(inputs.email & inputs.password){
                ...
                if(res.status===200){
                    setRes({...res,message:response.data,state:true,success:true});
                }else{
        ...
        <div className="w-[25vw] max-2xl:w-[35vw] max-xl:w-[40vw] max-lg:w-[50vw] max-md:w-[65vw] max-sm:w-[97vw] h-fit bg-white mt-[3.5rem] px-[1.5rem] py-[4rem] rounded">
            <div className="flex flex-col gap-8">
                ...
                <div className="w-full">
                    <Button onClick={handleSubmit} size='small' variant='contained' sx={{fontSize:'0.85rem',textTransform:'capitalize',width:'100%'}}>LogIn</Button>
