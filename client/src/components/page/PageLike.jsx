...
function PageLike({id}) {
    // liked 
    const [liked,setLiked] = React.useState(false);

  return (
    <button className='w-full flex flex-row items-center gap-1 text-[0.975rem] font-medium' onClick={()=>setLiked(!liked)}>
        <span>
            {
                liked?
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" className='text-sky-500'>
                    ...
                    <path fill="currentColor" fillRule="evenodd" d="M2.968 9.485a.75.75 0 0 1 .78.685l.97 11.236a1.237 1.237 0 1 1-2.468.107V10.234a.75.75 0 0 1 .718-.749" clipRule="evenodd" opacity="0.5"/>
                </svg>:
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" className='text-sky-600'>
        ...
        <span className='text-sky-500 font-comic-neue font-medium'>
            {
                liked?
                "unlike Post":
                "liked Post"
